...
protocol MessageProductCellDelegate {
    func increaseNumber(cell: MessageProductCellDelegate,number : Int)
    func decreaseNumber(cell: MessageProductCellDelegate,number : Int)
}

class MessageproductCell : UITableViewCell {
